...
build: 
	...
	$(CC) $(CFLAGS) -g src/main.c -Llib/ -lndimarr -lnnetfunc -lnnetmodels -o $(BIN_DIR)/main -framework Accelerate	
	$(BIN_DIR)/main
...
test:
	...
	$(CC) $(CFLAGS) -I$(HEADER_DIR) -c lib/nnetmodels.c -o lib/nnetmodels.o
	ar rcs lib/libnnetmodels.a lib/nnetmodels.o
	$(CC) $(CFLAGS) -g test/ndimarr.c -Llib/ -lndimarr -lnnetfunc -lnnetmodels -o $(BIN_DIR)/run_tests -framework Accelerate
	$(BIN_DIR)/run_tests
